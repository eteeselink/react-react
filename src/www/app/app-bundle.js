...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(React) {"use strict";  /** @jsx React.DOM *//* global Reveal */
	...
	var CrowdOMeter = __webpack_require__(1);
	var crowdOMeter = React.renderComponent(CrowdOMeter(null), document.getElementById('crowd-o-container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(React) {"use strict";  /** @jsx React.DOM */__webpack_require__(9);

	var Counter = __webpack_require__(11);
	var HeadCounts = __webpack_require__(15);

	var CrowdOMeter = React.createClass({displayName: 'CrowdOMeter',
	    getInitialState:function() {
	        return { 
	            visible: false,
	            headCounts: new HeadCounts(function()  {return this.forceUpdate();}.bind(this)),
	        };
	    },
	    ...
	    render:function() {
	        ...
	        return React.DOM.div({id: "crowd-o-app", style: style, className: "CrowdOMeter react-app"}, 
	            React.DOM.div(null, 
	            Counter({headCount: headCounts.html, initiallyVisible: true}, "HTML"), 
	            Counter({headCount: headCounts.js10}, "JavaScript", React.DOM.br(null), "(>10 LOC)"), 
	            Counter({headCount: headCounts.js500}, "JavaScript", React.DOM.br(null), "(>500 LOC)")
	            )
	            /*<p>Total: {total}</p>*/
	        );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(React) {"use strict";  /** @jsx React.DOM */__webpack_require__(13);
	...
	var Counter = React.createClass({displayName: 'Counter',
	    ...
	    render:function() {
	        if(!this.state.visible) {
	            return React.DOM.div({className: "Counter", onClick: this.show});
	        }

	        var $__0=   this.computeStyles(),upStyle=$__0[0],downStyle=$__0[1];
	        
	        return React.DOM.div({className: "Counter"}, 
	            React.DOM.div({className: "bar up", style: upStyle, onMouseDown: this.up}), 
	            React.DOM.div({className: "bar down", style: downStyle, onMouseDown: this.down}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports =
		".Counter {\n  *zoom: 1;\n  float: left;\n  clear: none;\n  text-align: inherit;\n  padding-left: 0;\n  padding-right: 0;\n  width: 31.3333333333333%;\n  margin-left: 0%;\n  margin-right: 3%;\n  text-align: center;\n  height: 40vh;\n}\n.Counter:before,\n.Counter:after {\n  content: '';\n  display: table;\n}\n.Counter:after {\n  clear: both;\n}\n.Counter:last-child {\n  margin-right: 0%;\n}\n.Counter .bar {\n  margin: 0 auto;\n  width: 40%;\n}\n.Counter .bar.down {\n  background-color: #24a8da;\n  text-align: center;\n  color: #fff;\n}\n";

/***/ },
/* 15 */
/***/ function(module, exports, __webpack_require__) {

	"use strict";  /** @jsx React.DOM */

	    function HeadCount(refreshView, initialTotal, limiter) {"use strict";
	        this.$HeadCount_total = initialTotal;
	        this.$HeadCount_amount = initialTotal;
	        this.$HeadCount_limiter = limiter;
	        this.$HeadCount_refreshView = refreshView;
	    }

	    HeadCount.prototype.total=function() {"use strict";
	        if(this.$HeadCount_limiter) {
	            return this.$HeadCount_limiter.amount();
	        }
	        else {
	            return this.$HeadCount_total;
	        }
	    };

	    HeadCount.prototype.amount=function() {"use strict";
	        return Math.min(this.total(), this.$HeadCount_amount);
	    };
	    
	    HeadCount.prototype.setAmount=function(amount) {"use strict"; 
	        this.$HeadCount_amount = amount; 
	        this.$HeadCount_refreshView();
	    };



	    function HeadCounts(refreshView) {"use strict";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCurrentOwner = __webpack_require__(22);
	var ReactDescriptor = __webpack_require__(23);
	var ReactDescriptorValidator = __webpack_require__(49);
	...
	var keyMirror = __webpack_require__(48);
	var merge = __webpack_require__(45);
	var mixInto = __webpack_require__(56);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mergeInto = __webpack_require__(60);
	var mapObject = __webpack_require__(58);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var emptyFunction = __webpack_require__(95);
	var invariant = __webpack_require__(38);
	var joinClasses = __webpack_require__(101);
	var merge = __webpack_require__(45);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mergeHelpers = __webpack_require__(102);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var copyProperties = __webpack_require__(140);
